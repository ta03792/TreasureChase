...
public class MazeGenerator : MonoBehaviour {
    ...
    public void CreateLayout()
    {
        ...
        Vector3 wizpos = new Vector3(6.75f,-3.75f, 0);
        Vector3 pirpos = new Vector3(-6.75f, -3.75f, 0);
        Vector3 ninpos = new Vector3(6.75f, 3.75f, 0);
        Vector3 barpos = new Vector3(-6.75f, 3.75f, 0);
        Instantiate(character[0], wizpos, transform.rotation);
        Instantiate(character[1], pirpos, transform.rotation);
        Instantiate(character[2], ninpos, transform.rotation);
        Instantiate(character[3], barpos, transform.rotation);
